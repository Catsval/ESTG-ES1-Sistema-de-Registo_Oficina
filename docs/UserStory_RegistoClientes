### Registro Simplificado de Clientes

**Como** um gerente de uma oficina mecânica,  
**Gostaria de** oferecer aos clientes a capacidade de se registrarem facilmente em nosso sistema,  
**Para que** possamos manter um banco de dados atualizado e proporcionar um serviço personalizado aos nossos clientes.

**Critérios de Aceitação**:
1. **Registro de Novo Cliente**: Deve haver um formulário intuitivo que permita aos clientes inserir suas informações básicas, como nome completo, endereço, número de telefone e endereço de e-mail.
